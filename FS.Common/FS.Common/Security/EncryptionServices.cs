...
namespace FS.Common.Security
{
    ...
    public class EncryptionServices
    {
        ...
        public string DefaultDecryption(string cypherText)
        {
            ...
            return this.Decrypt(cypherText, FS.Common.Security.EncryptionServices.Settings.EncryptPassPhrase,
FS.Common.Security.EncryptionServices.Settings.EncryptSaltValue,
FS.Common.Security.EncryptionServices.Settings.EncryptHashAlgorithm,
FS.Common.Security.EncryptionServices.Settings.EncryptPassIterations,
FS.Common.Security.EncryptionServices.Settings.EncryptInitVector, 256);
        }
        public string DefaultEncryption(string plainText)
        {
            ...
            return this.Encrypt(plainText, FS.Common.Security.EncryptionServices.Settings.EncryptPassPhrase,
FS.Common.Security.EncryptionServices.Settings.EncryptSaltValue,
FS.Common.Security.EncryptionServices.Settings.EncryptHashAlgorithm,
FS.Common.Security.EncryptionServices.Settings.EncryptPassIterations,
FS.Common.Security.EncryptionServices.Settings.EncryptInitVector, 256);
