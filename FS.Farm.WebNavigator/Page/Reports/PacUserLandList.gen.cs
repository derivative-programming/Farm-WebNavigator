...
namespace FS.Farm.WebNavigator.Page.Reports
{
    public class PacUserLandList : PageBase, IPage
    {
        ...
        public PageView BuildTableHeaders(PageView pageView)
        {
            {
                //LandCode
                pageView = BuildTableHeader(pageView, "landDescription",
                    isVisible: true,
                    "Description");
                pageView = BuildTableHeader(pageView, "landDisplayOrder",
                    isVisible: true,
                    "Display Order");
                pageView = BuildTableHeader(pageView, "landIsActive",
                    isVisible: true,
                    "Is Active");
                pageView = BuildTableHeader(pageView, "landLookupEnumName",
                    isVisible: true,
                    "Lookup Enum Name");
                pageView = BuildTableHeader(pageView, "landName",
                    isVisible: true,
                    "Name");
        ...
        public PageView BuildTableData(SessionData sessionData, PageView pageView, PacUserLandListListModel apiResponse)
        {
        ...
        public Dictionary<string, string> BuildTableDataRow(PacUserLandListListModelItem rowData)
        {
            Dictionary<string,string> keyValuePairs = new Dictionary<string, string>();

            {
                //LandCode
                keyValuePairs = BuildTableDataCellValue(keyValuePairs, "landDescription",
                    isVisible: true,
                    value: rowData.LandDescription.ToString());
                keyValuePairs = BuildTableDataCellValue(keyValuePairs, "landDisplayOrder",
                    isVisible: true,
                    value: rowData.LandDisplayOrder.ToString());
                keyValuePairs = BuildTableDataCellValue(keyValuePairs, "landIsActive",
                    isVisible: true,
                    value: rowData.LandIsActive.ToString());
                keyValuePairs = BuildTableDataCellValue(keyValuePairs, "landLookupEnumName",
                    isVisible: true,
                    value: rowData.LandLookupEnumName.ToString());
                keyValuePairs = BuildTableDataCellValue(keyValuePairs, "landName",
                    isVisible: true,
                    value: rowData.LandName.ToString());
        ...
        public PageView BuildAvailableCommandsForReportSort(PageView pageView, PacUserLandListListModel apiResponse)
        {
            if (apiResponse == null ||
            ...
            {
                //LandCode
                pageView = BuildAvailableCommandForSortOnColumn(pageView, "landDescription",
                    isVisible: true,
                    "Description");
                pageView = BuildAvailableCommandForSortOnColumn(pageView, "landDisplayOrder",
                    isVisible: true,
                    "Display Order");
                pageView = BuildAvailableCommandForSortOnColumn(pageView, "landIsActive",
                    isVisible: true,
                    "Is Active");
                pageView = BuildAvailableCommandForSortOnColumn(pageView, "landLookupEnumName",
                    isVisible: true,
                    "Lookup Enum Name");
                pageView = BuildAvailableCommandForSortOnColumn(pageView, "landName",
                    isVisible: true,
                    "Name");
        ...
        public PageView BuildAvailableCommandsForReportPaging(PageView pageView, PacUserLandListListModel apiResponse)
        {
            if (apiResponse == null ||
                apiResponse.Items == null ||
