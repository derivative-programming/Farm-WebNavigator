...
namespace FS.Farm.WebNavigator.Page.Reports
{
    public class PacUserLandList : PageBase, IPage
    {
        ...
        public async Task<PageView> BuildPageView(APIClient apiClient, Guid sessionCode, Guid contextCode, string postData = "")
        {
            ...
            PacUserLandListListModel apiResponse = await PostResponse(apiClient, apiRequestModel, contextCode);
        ...
        public PageView HandleReportRowButtons(PageView pageView, PacUserLandListListModel apiResponse)
        {
            if (apiResponse == null ||
