...
namespace FS.Farm.WebNavigator.Page.Reports
{
    public class PacUserDateGreaterThanFilterList : PageBase, IPage
    {
        ...
        private class PacUserDateGreaterThanFilterListListModel
        {
        ...
        private class PacUserDateGreaterThanFilterListListModelItem
        {
        ...
        private class PacUserDateGreaterThanFilterListListRequest
        {
