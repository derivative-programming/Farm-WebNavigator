...
namespace FS.Farm.WebNavigator.Page.Reports
{
    public class PacUserTacList : PageBase, IPage
    {
        ...
        public async Task<PageView> BuildPageView(APIClient apiClient, SessionData sessionData, Guid contextCode, string commandText = "")
        {
            ...
            //  handle report init
            PacUserTacListInitReport.GetInitResponse apiInitResponse = await initReportProcessor.RequestGetInitResponse(apiClient, contextCode);
            ...
            //  handle filter post
            PacUserTacListListModel apiResponse = await RequestGetResponse(apiClient, apiRequestModel, contextCode);
        ...
        public async Task<PageView> BuildTableAvailableFilters(APIClient apiClient, PageView pageView, PacUserTacListListModel apiResponse)
        {
            //if (apiResponse == null ||
        ...
        public async Task<PacUserTacListListModel> RequestGetResponse(APIClient aPIClient, PacUserTacListListRequest model, Guid contextCode)
        {
